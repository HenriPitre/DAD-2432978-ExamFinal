...
public class FonctionsDeBase
{
    ...
    /// <param name="texte">Le texte à afficher.</param>
    /// <param name="couleur">La couleur console du texte, par défaut White.</param>
    public static void AfficherTexteProgressif(string texte, ConsoleColor couleur = ConsoleColor.White, int letterInterval=25)
    {
        Console.ForegroundColor = couleur;
        ...
        /// <summary>
    /// Affiche une ligne de nb étoiles
    /// </summary>
    /// <param name="nbEtoiles">Nombre d'étoiles à afficher</param>
    /// <param name="couleur">Couleur de la ligne d'étoiles.</param>
    public static void AfficherEtoiles(int nbEtoiles, ConsoleColor couleur = ConsoleColor.White)
    {
        Console.ForegroundColor = couleur;
        for (int nb = 0; nb < nbEtoiles; nb++)
        {
            Console.Write("*");
        }
        Console.WriteLine("");
    ...
    public static string LireTexteNonVide(string message)
    {
        ...
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.Write("Saisie obligatoire, recommencez : ");
            Console.ResetColor();
            texte = Console.ReadLine() ?? "";
        }
